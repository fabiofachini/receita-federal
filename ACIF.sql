...
SELECT
    ...
    ROUND(CAST(COUNT(ASSOCIADOS.CNPJ) AS DECIMAL) / COUNT(ESTABELECIMENTOS.CNPJ_BASICO || ESTABELECIMENTOS.CNPJ_ORDEM || ESTABELECIMENTOS.CNPJ_DV), 4)*100 AS "%"
...
WHERE
    ESTABELECIMENTOS.SITUACAO_CADASTRAL = '02' AND ESTABELECIMENTOS.MUNICIPIO = '8105'
